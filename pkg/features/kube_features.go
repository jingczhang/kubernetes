...
const (
	...
	// owner: @jingczhang
	//
	// Subtracts hugepage capacity from memory.available so the eviction signal
	// reflects actual regular-memory availability. This corrects a long-standing
	// bug where hugepage-reserved RAM inflated AvailableBytes, delaying eviction.
	// Users observing regressions can disable this feature gate to restore the
	// old behavior. The feature gate will be locked to true in 1.39 and removed in 1.40.
...
var defaultVersionedKubernetesFeatureGates = map[featuregate.Feature]featuregate.VersionedSpecs{
	...
	HugepageAwareEviction: {
		...
		{Version: version.MustParse("1.35"), Default: true, PreRelease: featuregate.Deprecated}, // lock to default in 1.39, remove in 1.40
	},
